...
if __name__ == '__main__':
  parser = OptionParser()
  parser.add_option("--ticker", dest="ticker", metavar="TICKER", help="Stock ticker")
  parser.add_option("--period", dest="period", metavar="YAHOO_PERIOD", help="Valid periods: 1d, 5d, 1m, 3m, 6m, 1y, 2y, 5y, 10y")
